...
from utils.functions_lobby import all_categories_names_and_links, get_all_categories, export_categories_to_csv, \
     get_products_from_api, add_multiple_products
        ...
        try:
            ...
            try:
                ...
                for category in categories_list_from_csv:
                    ...
                    number_of_pages = pagination.get("totalPages")
                    number_of_products = pagination.get("totalResults")
                    ...
                    for curr_page in range(1, number_of_pages+1):
                        ...
                        if not products:
                            continue
                        add_multiple_products(products, title)
                        time.sleep(0.2)
